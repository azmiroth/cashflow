...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        ...
        @if($organisation->bankAccounts->count() > 0)
        <a href="{{ route('imports.create', [$organisation->id, $organisation->bankAccounts->first()->id]) }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
            + Import CSV
        </a>
        @endif
    </div>
